///////////////////////////////////////////////////////////////////////////////
///  CStereoVideo.h
///  Main class that connect's to stereo camera or video files or image InputFrames and generates stereo InputFrames
///
///  @remarks 
///
...
/*
* Structure responsible for holding one InputFrame from both eyes taken in the same time.
*/
typedef struct StereoInputFrame
{
	IplImage *_leftIm;
	IplImage *_rightIm;
}StereoInputFrame;
/*
* Class responsible for communication with the stereo camera.
*/
class CStereoVideo
{
public:
	CAppConfig _config;
	int _leftCamNum,_rightCamNum;
	int _InputFrameCounter;
    CvCapture *_leftCam;
	CvCapture *_rightCam;
	StereoInputFrame * _images;
	CStereoVideo();
	CStereoVideo(CAppConfig conf);
	CStereoVideo(int leftCam,int rightCam);
    virtual void Connect();
	virtual void ContiniousCaptureLoop();
	virtual void ContiniousProcessInputFrame(StereoInputFrame * InputFrame);
	virtual StereoInputFrame *GetSingleInputFrame();
};